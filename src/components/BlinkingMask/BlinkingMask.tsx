...
const BlinkingMask: FunctionComponent<BlinkingMask> = () => {
    return (
        <div className="blinking-mask">
            <div className="blinking-mask__phrase blinking-mask__phrase--1"><Image src="/static/img/the_illest.svg" width={17} height={99} /></div>
            <div className="blinking-mask__phrase blinking-mask__phrase--2"><Image src="/static/img/the_illest.svg" width={17} height={99} /></div>

            <div className="blinking-mask__beams__wrapper">
                <div className="blinking-mask__beam blinking-mask__beams--large">
                    <Image src="/static/img/beams_large.svg" width={635} height={635} />
                </div>
                <div className="blinking-mask__beam blinking-mask__beams--small">
                  <Image src="/static/img/beams_small.svg" width={435} height={435} />
                </div>
                <div className="blinking-mask__flare">
                    <Image src="/static/img/flare.svg" width={181} height={181} />
                </div>
